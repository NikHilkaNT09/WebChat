...
{
    std::cout << "__entered chat frame__" << std::endl;
    std::cout << "__user :" << user << "__pass : " << pass << std::endl;
 ...
 /*
    ...
    */
    ...
    // m_clientModule->setMessageCallback([this](const std::string& data) {
    //     std::cout << "__received data__" << data << std::endl;
    ...
    //             std::cout << "__login succes__" <<std::endl;
...
void ChatFrame::sendMessage(std::string msg){
    std::cout << "__sending message from frame: " << msg << std::endl;
    m_comm->sendData(msg);
}
